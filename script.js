        ...
        <div class="sidecart" id="sidecart">
            ...
            <div class="sidecart-content-scroll">
                ...
                <div class="sidecart-footer">
                    ...
                    <p id="sidecartSavingsBanner" style="display: none; color: #137333; text-align: center; font-weight: bold; margin-bottom: 1rem; font-size: 0.95rem;"></p>
...
function renderSidecart() {
    ...
    if (cart.length === 0) {
        ...
        cart.forEach(item => {
            ...
            const saveText = discountAmount > 0 ? `${savePct}% OFF | SAVE ${formatter.format(discountAmount).replace('INR', '₹').trim()}` : '';
    ...
    if (savingsBanner) {
        if (totalSavings > 0) {
            ...
            savingsBanner.innerHTML = `You are saving ${formattedSavings}`;
